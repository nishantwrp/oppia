...
describe('Exploration history', function() {
  ...
  it('should display the history', function() {
    ...
    var VERSION_1_STATE_1_CONTENTS = {
      ...
      12: {
        text: '      labelledAsCorrect: false',
        highlighted: true
      },
      13: {
        text: '      missingPrerequisiteSkillId: null',
        highlighted: true
      },
      14: {
        text: '      paramChanges: []',
      ...
      15: {
        text: '      refresherExplorationId: null',
        highlighted: true
      },
      16: {
        text: '    ruleSpecs:',
      ...
      19: {
        text: '      ruleType: Equals',
        highlighted: true
      },
      20: {
        text: '    taggedSkillMisconceptionId: null',
        highlighted: true
      },
      21: {
        text: '    trainingData: []',
      ...
      22: {
        text: '  confirmedUnclassifiedAnswers: []',
        highlighted: false
      },
      23: {
        text: '  customizationArgs: {}',
        highlighted: false
      },
      24: {
        text: '  defaultOutcome:',
      ...
      27: {
        text: '      contentId: default_outcome',
        highlighted: false
      },
      28: {
        text: '      html: \'\'',
      ...
      37: {
        text: 'recordedVoiceovers:',
        highlighted: false
      },
      38: {
        text: '  voiceoversMapping:',
        highlighted: false
      },
      39: {
        text: '    content: {}',
      ...
      42: {
        text: 'solicitAnswerDetails: false',
        highlighted: false
      },
      43: {
        text: 'writtenTranslations:',
        highlighted: false
      },
      44: {
        text: '  translationsMapping:',
        highlighted: false
      },
      45: {
        text: '    content: {}',
